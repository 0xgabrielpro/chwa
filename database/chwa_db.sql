...
(2, 4, 8, 3, '2024-06-21', '2024-06-19 08:37:59'),
(3, 5, 8, 3, '2024-06-18', '2024-06-19 11:51:50');
...
(6, 'asdasd', 'asdasd@asdasd.com', 'asdasd', 'asdasd', 1, '2024-06-19 10:19:27');
...
INSERT INTO `events` (`title`, `event_date`, `location`, `description`, `video_path`, `status`, `date_created`) VALUES
('Event 1', '2024-06-20 18:00:00', 'Location 1', 'Description for Event 1', 'upload_dir/event_50/1719081069_VID-20240515-WA0006...', 1, current_timestamp()),
('Event 2', '2024-07-15 20:00:00', 'Location 2', 'Description for Event 2', 'upload_dir/event_1719081159/1719081159_VID-2024051...', 1, current_timestamp()),
('Event 3', '2024-08-10 15:00:00', 'Location 3', 'Description for Event 3', 'http://example.com/video3', 2, current_timestamp());
...
(4, 5, 8, 3, '&lt;p&gt;Sample feedback only&lt;/p&gt;', '2024-06-19 13:49:26');
...
(1, 'name', 'Culture and heritage web applicationS'),
(6, 'short_name', 'CHWA'),
...
INSERT INTO `users` (`id`, `firstname`, `lastname`, `username`, `password`, `phonenumber`, `email`, `avatar`, `last_login`, `type`, `date_added`, `date_updated`) VALUES
(1, 'Adminstrator', 'Admin', 'admin', '0192023a7bbd73250516f069df18b500', '123-456-7890', 'admin@example.com', 'uploads/1620201300_avatar.png', NULL, 1, '2024-01-20 14:02:37', '2024-06-18 16:47:05'),
(4, 'John', 'Smith', 'jsmith', '1254737c076cf867dc53d60a0364f38e', '555-123-4567', 'jsmith@example.com', NULL, NULL, 0, '2024-06-19 08:36:09', '2024-06-19 10:53:12'),
(5, 'Claire', 'Blake', 'cblake', '4744ddea876b11dcb1d169fadf494418', '555-987-6543', 'cblake@example.com', NULL, NULL, 0, '2024-06-19 10:01:51', '2024-06-19 12:03:23');
