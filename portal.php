...
<header class="masthead">
	<div class="container">
		<div class="masthead-subheading">Welcome To Culture and Heritage Site</div>
		<div class="masthead-heading text-uppercase">Explore our Culture and Heritage</div>
		<a class="btn btn-primary btn-xl text-uppercase" href="#home">View Cultures and Heritage</a>
	</div>
</header>
<!-- Services-->
<section class="page-section bg-dark" id="home">
	<div class="container">
		<h2 class="text-center">culture and heritage Packages</h2>
